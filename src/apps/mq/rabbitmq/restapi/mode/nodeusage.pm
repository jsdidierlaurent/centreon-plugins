...
You can use the following variables: %{status}, %{watermark}, %{display}

=item B<--critical-status>

Define the conditions to match for the status to be CRITICAL (default: '%{status} ne "running" || %{watermark} ne "notrunning"').
You can use the following variables: %{status}, %{watermark}, %{display}
